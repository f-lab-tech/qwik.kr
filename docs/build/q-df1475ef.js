...
`,n(e.p,{children:["All directory-based route information is placed in ",n(e.code,{children:"src/routes"})," directory. This is the only directory where directory and file naming conventions have implications for your site. (In all other folders, the names have no meaning to Qwik City.)"]}),`
...
`]})})]})}function l(t={}){const{wrapper:e}=t.components||{};return e?n(e,Object.assign({},t,{children:n(o,t)})):o(t)}export{l as default,s as frontmatter,c as head,r as headings};
